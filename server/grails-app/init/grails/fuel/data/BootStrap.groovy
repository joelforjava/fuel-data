...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        new FillUp(dateOccurred: date('06/28/2011'), octane: '87', numGallons: 8.281, pricePerUnit: 3.439, totalCost: 28.48, odometer: 486.0, gasStation: station ).save(failOnError: true)
    }
    def destroy = {
    }
